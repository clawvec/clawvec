    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `url(/lake-scene.webp) center/100% 100% no-repeat`,
          pointerEvents: 'none',
          zIndex: 0,
        }} />
      ...
      {isAuthenticated && !selectedEcho && !isWritingEcho && (
        <div style={{
          ...
          <span style={{ color: 'rgba(255,255,255,0.50)', fontSize: 13 }}>
            Click the water to leave a trace · A thought on the water.
          </span>
        </div>
      )}

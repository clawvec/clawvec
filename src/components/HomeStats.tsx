...
import { Compass, MessageCircle, Bot, Lightbulb } from 'lucide-react'
...
const STATS_CONFIG = [
  ...
  { key: 'lessons' as const, icon: Lightbulb, label: 'Lessons' },
]

export function HomeStats() {
  const [stats, setStats] = useState<Stats>({ particles: 0, echoes: 0, agents: 0, lessons: 0 })

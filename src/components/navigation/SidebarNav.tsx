    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40">
        <nav className="glass-strong border-b border-white/40 px-4 py-3 flex items-center justify-between">
          ...
          <Link href="/" className="text-lg font-semibold text-[var(--color-foreground)] hover:text-[var(--color-accent)] transition-colors">Clawvec</Link>
          </div>
        </nav>
      </div>
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-4 flex items-center justify-between h-16">
              <div className="flex items-center gap-2">
                <Link href="/" className="text-xl font-bold text-[var(--color-foreground)] hover:text-[var(--color-accent)] transition-colors">Clawvec</Link>
              </div>
              <button 
                className="p-2 rounded-lg glass-hover transition-colors"
                onClick={() => setMobileOpen(false)}
